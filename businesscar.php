...
$branch = $_SESSION['branch'];
  ...
  $q1 ="SELECT COUNT(*) as COUNT from Car , Branch , CarType , Model WHERE Car.BRANCH_ID = Branch.BRANCH_ID AND  Car.MODEL_ID = Model.MODEL_ID AND Car.CAR_TYPE_ID=CarType.CAR_TYPE_ID AND Branch.COUNTRY='".$branch."'AND CarType.TYPENAME = 'BUSINESS CAR' AND Car.AVAILABLE = 1 AND Model.MODEL_NAME = 'CAMRY' ";
 
 $q2 = "SELECT COUNT(*) as COUNT from Car , Branch , CarType , Model WHERE Car.BRANCH_ID = Branch.BRANCH_ID AND  Car.MODEL_ID = Model.MODEL_ID AND Car.CAR_TYPE_ID=CarType.CAR_TYPE_ID AND Branch.COUNTRY= '".$branch."' AND CarType.TYPENAME = 'BUSINESS CAR' AND Car.AVAILABLE = 1 AND Model.MODEL_NAME = 'ACCORD' ";




 $q3 = "SELECT COUNT(*) as COUNT from Car , Branch , CarType , Model WHERE Car.BRANCH_ID = Branch.BRANCH_ID AND  Car.MODEL_ID = Model.MODEL_ID AND Car.CAR_TYPE_ID=CarType.CAR_TYPE_ID AND Branch.COUNTRY= '".$branch."' AND CarType.TYPENAME = 'BUSINESS CAR' AND Car.AVAILABLE = 1 AND Model.MODEL_NAME = 'TEANA' ";
...
<!-- - - - - - - - - - - - - main part - - - - - - - - - - - - - - - - -->
			...
			<section class="container" >
				...
				<div class="list-cars">
					...
					<h3 class="widget-title">Business Car</h3>
					...
					<ul class = "box3" >
						...
						<li >
							...
							<div class="detailed">
								<span class="cost"> 1500  THB/D</span>
 ...
 <?php }else{ ?>
     ...
     <form action="businesscar.php" method="post">
 ...
 <?php } ?>
						...
						<li>
							...
							<a href="cart.html" >
								<h6 class="title-list-item">Accord</h6>
							</a>
 ...
 <?php } ?>
						...
						<li>
							...
							<div class="rcorners">
							<img src="images/teana.jpg" alt="" />

							

							<a href="#" >
								<h6 class="title-list-item">Teana</h6>
							</a>

							<div class="detailed">
								<span class="cost"> 1400 THB/D</span>
  ...
  <input type="hidden" name="model" value="TEANA">
  <input type="hidden" name="branch" value=<?php echo $branch;?>>
